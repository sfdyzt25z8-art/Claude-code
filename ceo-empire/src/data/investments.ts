...
const HAND_AUTHORED_ASSETS: InvestmentAsset[] = [
  ...
  {
    id: 'harborfront_marina',
    name: 'Harborfront Marina',
    symbol: 'RE-HFM',
    category: 'real_estate',
    basePrice: 3900,
    volatility: 0.006,
  ...
  {
    id: 'metro_parking_fund',
    name: 'Metro Parking Fund',
    symbol: 'RE-MPF',
    category: 'real_estate',
    basePrice: 1450,
    volatility: 0.005,
...
const BUSINESS_STOCK_SYMBOLS: Record<string, string> = {
  ...
  vineyard: 'VINE',
  data_center: 'RACK',
  craft_distillery: 'STIL',
  event_venue: 'FETE',
  shipping_port_terminal: 'PORT',
  biotech_startup: 'GENE',
  luxury_resort_chain: 'RSRT',
  semiconductor_fab: 'CHIP',
  investment_fund: 'FUND',
  streaming_platform: 'STRM',
  global_shipping_line: 'GLOB',
};
